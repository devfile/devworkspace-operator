...
type AltComponentSpec struct {
	Type                     DevfileName `json:"type"` // Describes type of the component, e.g. whether it is an plugin or editor or other type
	PluginOrEditor *PluginOrEditorSpec       `json:"pluginOrEditor,omitempty"`
	DockerImage *DockerImageComponentSpec `json:"dockerImage,omitempty"`
}

type BaseComponentSpec struct {
	Alias        string `json:"alias"`                  // Describes the name of the component. Should be unique per component set.
...
type PluginOrEditorSpec struct {
	BaseComponentSpec `json:",inline"`
...
type DockerImageComponentSpec struct {
	BaseComponentSpec `json:",inline"`
