...
Arguments:
  ...
  --default-image
      ...
      value of 'quay.io/devfile/devworkspace-controller:v0.24.0' is used
  --project-clone-image
      ...
      'quay.io/devfile/project-clone:v0.24.0' is used.
  --split-yaml
...
if $USE_DEFAULT_ENV; then
  ...
  export DWO_IMG=${DEFAULT_DWO_IMG:-"quay.io/devfile/devworkspace-controller:v0.24.0"}
  export PROJECT_CLONE_IMG=${PROJECT_CLONE_IMG:-"quay.io/devfile/project-clone:v0.24.0"}
