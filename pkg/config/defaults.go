...
// still works in clusters with limit ranges configured, this quantity is used when a limitrange may set a default value for CPU limit
// and the Operator's configuration does not specify a non-default value.
