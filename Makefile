...
export DWO_IMG ?= quay.io/devfile/devworkspace-controller:v0.7.2
...
export PROJECT_CLONE_IMG ?= quay.io/devfile/project-clone:v0.7.2
...
docker-push:
ifneq ($(INITIATOR),CI)
ifeq ($(DWO_IMG),quay.io/devfile/devworkspace-controller:v0.7.2)
