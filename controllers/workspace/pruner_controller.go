...
func (r *PrunerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if config.Config.Workspace == nil || config.Config.Workspace.CleanupCronJob == nil || config.Config.Workspace.CleanupCronJob.Enable == nil || *config.Config.Workspace.CleanupCronJob.Enable == false {
