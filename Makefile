...
export DWO_IMG ?= quay.io/devfile/devworkspace-controller:v0.18.0
export DWO_BUNDLE_IMG ?= quay.io/devfile/devworkspace-operator-bundle:v0.18.0
export DWO_INDEX_IMG ?= quay.io/devfile/devworkspace-operator-index:release
export PROJECT_CLONE_IMG ?= quay.io/devfile/project-clone:v0.18.0
...
docker-push:
  ifneq ($(INITIATOR),CI)
    ifeq ($(DWO_IMG),quay.io/devfile/devworkspace-controller:v0.18.0)
